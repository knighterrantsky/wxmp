...
describe('metrics', () => {
  it('uses a private per-instance registry with bounded labels', async () => {
    ...
    expect(exposition).toMatch(/wx_upload_abort_backlog/)
    expect(exposition).toMatch(/wx_upload_reconciliation_total/)
    expect(exposition).toMatch(/wx_upload_critical_reconciliation_total/)
